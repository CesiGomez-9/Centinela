...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <a href="<?php echo e(route('facturas.create')); ?>" class="btn btn-sm btn-outline-primary mb-2">
    ...
    <?php endif; ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $facturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $factura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="factura-row">
                ...
                <td>
                    <a href="<?php echo e(route('facturas.show', $factura->id)); ?>" class="btn btn-sm btn-outline-info">
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\PhpstormProjects\Centinela\resources\views/facturas/index.blade.php ENDPATH**/ ?>