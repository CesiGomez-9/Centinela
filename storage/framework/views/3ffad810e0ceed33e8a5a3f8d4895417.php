...
unset($__errorArgs, $__bag); ?></div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <select name="modalidad" id="modalidad" class="form-select <?php $__errorArgs = ['modalidad'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       max="<?php echo e(now()->addMonths(2)->format('Y-m-d')); ?>"
                                       required>
                            </div>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cesig\Herd\sistemadeseguridadcentinela\resources\views/capacitaciones/edit.blade.php ENDPATH**/ ?>