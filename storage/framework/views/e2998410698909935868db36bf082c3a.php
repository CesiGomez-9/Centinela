        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="bg-white p-5 rounded shadow-lg position-relative">
                    ...
                    <form method="POST" id="facturaForm" action="<?php echo e(isset($factura) ? route('facturas_compras.update', $factura->id) : route('facturas_compras.store')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <?php if(isset($factura)): ?>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\angel\PhpstormProjects\Centinela\resources\views/facturas_compras/formulario.blade.php ENDPATH**/ ?>