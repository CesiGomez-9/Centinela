...
<div class="card position-relative">
    ...
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-md-6 mb-3 mb-md-0">
                <div class="card-interno h-100">
                    <div class="d-flex align-items-center mb-3">
                        <img src="<?php echo e(asset('centinela.jpg')); ?>" alt="Logo Centinela" width="70" class="me-3" />
                        <div>
            ...
            <div class="col-md-6">
                <div class="card-interno h-100">
                    <p><strong>Factura de venta N°:</strong> <?php echo e($factura->numero); ?></p>
                    <p><strong>Fecha:</strong> <?php echo e(\Carbon\Carbon::parse($factura->fecha)->format('d/m/Y')); ?></p>
                    <p><strong>Cliente:</strong> <?php echo e($factura->cliente->nombre ?? 'N/A'); ?></p>
                    <p><strong>Forma de pago:</strong> <?php echo e($factura->forma_pago); ?></p>
                    <p><strong>Responsable:</strong> <?php echo e($factura->responsable->nombre ?? ''); ?> <?php echo e($factura->responsable->apellido ?? ''); ?></p>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\angel\PhpstormProjects\Centinela\resources\views/facturas_ventas/show.blade.php ENDPATH**/ ?>