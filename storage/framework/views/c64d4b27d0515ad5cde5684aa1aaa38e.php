...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        $empleados->filter(fn($e) => $e->categoria === 'Administración')
                  ->map(fn($e) => [
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cesig\Herd\sistemadeseguridadcentinela\resources\views/incidencias/formulario.blade.php ENDPATH**/ ?>