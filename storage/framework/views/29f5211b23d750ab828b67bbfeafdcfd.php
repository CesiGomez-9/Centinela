                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        <p><i class="bi bi-clock-history me-2"></i><strong>Hora de entrada:</strong>
                            <?php echo e($asistencia->hora_entrada ? \Carbon\Carbon::parse($asistencia->hora_entrada)->format('h:i A') : 'No registrada'); ?>

                        </p>
                        <p><i class="bi bi-clock me-2"></i><strong>Hora de salida:</strong>
                            <?php echo e($asistencia->hora_salida ? \Carbon\Carbon::parse($asistencia->hora_salida)->format('h:i A') : 'No registrada'); ?>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                ...
                <form method="GET" class="d-flex gap-2 align-items-start flex-wrap">
                    <div class="d-flex flex-column gap-1">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="date" name="fecha_inicio" class="form-control"
                                   value="<?php echo e(request('fecha_inicio') ?? \Carbon\Carbon::now()->format('Y-m-d')); ?>"
                                   max="<?php echo e(\Carbon\Carbon::now()->addMonths(2)->format('Y-m-d')); ?>">
                        </div>
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">Hasta</span>
                            <input type="date" name="fecha_fin" class="form-control"
                                   value="<?php echo e(request('fecha_fin') ?? \Carbon\Carbon::now()->format('Y-m-d')); ?>"
                                   min="<?php echo e(\Carbon\Carbon::now()->subMonths(2)->format('Y-m-d')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-column gap-1">
                        ...
                        <a href="<?php echo e(route('asistencias.show', $asistencia->id)); ?>" class="btn btn-sm btn-secondary px-2 py-1">
            ...
            <div class="table-responsive">
                <?php if($historial->isNotEmpty()): ?>
                    <table class="table table-bordered historial-table text-center">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $historial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($index + 1); ?></td>
                                <td><?php echo e($item->created_at->format('d/m/Y')); ?></td>
                                <td><?php echo e($item->hora_entrada ? \Carbon\Carbon::parse($item->hora_entrada)->format('h:i A') : 'No registrada'); ?></td>
                                <td><?php echo e($item->hora_salida ? \Carbon\Carbon::parse($item->hora_salida)->format('h:i A') : 'No registrada'); ?></td>
                                <td><?php echo e($item->turno?->tipo_turno ?? 'Sin turno'); ?></td>
                            </tr>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\angel\PhpstormProjects\Centinela\resources\views/asistencias/show.blade.php ENDPATH**/ ?>