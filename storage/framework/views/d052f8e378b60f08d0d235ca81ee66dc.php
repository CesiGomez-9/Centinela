    ...
    <div class="container mt-5" style="max-width:900px;">
        <div class="card shadow p-4 bg-white position-relative">
            ...
            <h3 class="text-center mb-4" style="color:#09457f;">
                <i class="bi bi-tags-fill me-2"></i>Editar descuento
            </h3>

            <?php if(session('success')): ?>
                <div class="alert alert-success text-center">¡Descuento actualizado correctamente!</div>
            <?php endif; ?>

            <form action="<?php echo e(route('descuentos.update', $descuento->id)); ?>" method="POST" id="descuentoForm" novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('nombre', $descuento->nombre)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('fecha_inicio', $descuento->fecha_inicio)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('fecha_fin', $descuento->fecha_fin)); ?>">
                            ...
                            <select name="producto_id" id="producto_id" class="form-select">
                                ...
                                <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($producto->id); ?>"
                                        <?php echo e(old('producto_id', $descuento->producto_id) == $producto->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('valor', $descuento->valor)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                      style="overflow:hidden; resize:none;"><?php echo e(old('descripcion', $descuento->descripcion)); ?></textarea>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" id="activo" name="activo"
                                <?php echo e(old('activo', $descuento->activo) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cesig\Herd\sistemadeseguridadcentinela\resources\views/descuentos/edit.blade.php ENDPATH**/ ?>