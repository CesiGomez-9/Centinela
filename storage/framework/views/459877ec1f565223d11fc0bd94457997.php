        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            searchInput.addEventListener('input', function () {
                ...
                timeout = setTimeout(() => {
                    ...
                    // Limpiar parámetros previos para evitar acumulación
                    url.searchParams.delete('nombre');
                    url.searchParams.delete('apellido');
                    url.searchParams.delete('identidad');
                    url.searchParams.delete('departamento');

                    // Asignar el mismo valor a cada parámetro
                    url.searchParams.set('nombre', search);
                    url.searchParams.set('apellido', search);
                    url.searchParams.set('identidad', search);
                    url.searchParams.set('departamento', search);
...
<?php echo $__env->make("plantilla", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\PhpstormProjects\Centinela\resources\views/Clientes/indexCliente.blade.php ENDPATH**/ ?>