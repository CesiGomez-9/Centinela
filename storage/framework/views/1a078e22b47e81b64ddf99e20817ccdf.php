    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center mb-3">
                ...
                <small>Memorando N° <?php echo e($memorando->id); ?></small>
            </div>

            <div class="info-container">
                <!-- Cuadro Empleado, Autor, Título -->
                <div class="info-box">
                    <p><i class="bi bi-person-fill me-2"></i><strong>Empleado:</strong> <?php echo e($memorando->destinatario->nombre ?? ''); ?> <?php echo e($memorando->destinatario->apellido ?? ''); ?></p>
                    <p><i class="bi bi-person-fill me-2"></i><strong>Autor:</strong> <?php echo e($memorando->autor->nombre ?? ''); ?> <?php echo e($memorando->autor->apellido ?? ''); ?></p>
                ...
                <div class="info-box mb-3 p-3 border rounded shadow-sm">
                    ...
                    <?php if($memorando->adjunto): ?>
                        ...
                        <?php if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                            <img src="<?php echo e(asset('storage/' . $memorando->adjunto)); ?>"
                                 alt="Adjunto"
                                 class="img-fluid rounded shadow"
                                 style="max-height:300px;">
                        <?php elseif($extension === 'pdf'): ?>
                            <iframe src="<?php echo e(asset('storage/' . $memorando->adjunto)); ?>"
                                    width="100%"
                                    height="400px"
                                    class="border rounded mt-2"></iframe>
                        <?php else: ?>
                            <a href="<?php echo e(asset('storage/' . $memorando->adjunto)); ?>"
                               target="_blank"
