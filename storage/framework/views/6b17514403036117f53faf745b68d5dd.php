<?php $__env->startSection('content'); ?>
    ...
    <!-- Hero Section -->
    <div class="hero-section text-white d-flex align-items-center justify-content-center" style="background-image: url('<?php echo e(asset('fondo2.jpg')); ?>'); background-size: cover; background-position: center; height: 450px; position: relative; text-align: center;">
    ...
    <div class="container my-5">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="card service-card h-100 shadow-sm border-0">
                    <img src="<?php echo e(asset('vigilanciaresi.jpg')); ?>" class="card-img-top" alt="Vigilancia Residencial">
            ...
            <div class="col-md-4">
                <div class="card service-card h-100 shadow-sm border-0">
                    <img src="<?php echo e(asset('monitoreo.jpeg')); ?>" class="card-img-top" alt="Monitoreo Remoto de Cámaras">
                    <div class="card-body text-center">
            ...
            <div class="col-md-4">
                <div class="card service-card h-100 shadow-sm border-0">
                    <img src="<?php echo e(asset('instalacion.jpg')); ?>" class="card-img-top" alt="Instalación de Cámaras de Seguridad">
                    <div class="card-body text-center">
        ...
        <div class="row g-4 justify-content-center mt-3">
            ...
            <div class="col-md-4">
                <div class="card service-card h-100 shadow-sm border-0">
                    <img src="<?php echo e(asset('instalacionA.jpg')); ?>" class="card-img-top" alt="Instalación de Sistemas de Alarma">
                    <div class="card-body text-center">
            ...
            <div class="col-md-4">
                <div class="card service-card h-100 shadow-sm border-0">
                    <img src="<?php echo e(asset('mantenimiento.jpg')); ?>" class="card-img-top" alt="Mantenimiento de Sistemas de Seguridad">
                    <div class="card-body text-center">
            ...
            <div class="col-md-4">
                <div class="card service-card h-100 shadow-sm border-0">
                    <img src="<?php echo e(asset('cercas.jpg')); ?>" class="card-img-top" alt="Instalación de Cercas Eléctricas">
                    <div class="card-body text-center">
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cesig\Herd\sistemadeseguridadcentinela\resources\views/index.blade.php ENDPATH**/ ?>