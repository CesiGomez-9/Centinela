                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive product-table-container">
                            <table class="table table-bordered table-striped text-center">
                                ...
                                <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $turno->empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($empleado->nombres ?? $empleado->nombre?? 'N/A'); ?></td>
                                        <td><?php echo e(Str::ucfirst($empleado->pivot->tipo_turno ?? 'N/A')); ?></td>
                                        <td><?php echo e($empleado->pivot->hora_inicio ?? 'N/A'); ?></td>
                                        <td><?php echo e($empleado->pivot->hora_fin ?? 'N/A'); ?></td>
                                        <td><?php echo e(number_format($empleado->pivot->costo ?? 0, 2)); ?></td>
                                    </tr>
                                        ...
                                        <div class="summary-item total">
                                            ...
                                            <?php
                                                ...
                                                foreach ($turno->empleados ?? [] as $empleado) {
                                                    $total_costo += $empleado->pivot->costo ?? 0;
                                                }
                                            ?>
