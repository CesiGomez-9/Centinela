        ...
        <?php if(auth()->guard()->check()): ?>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                    ...
                    <?php echo e(Auth::user()->empleado->nombre ?? Auth::user()->usuario); ?>
                ...
                <ul class="dropdown-menu">
                    <li>
                        <span class="dropdown-item-text text-muted small">
                            ...
                            <?php echo e(Auth::user()->rol ?? 'Sin rol'); ?>
            ...
            <?php $isSuperAdmin = Auth::user()->hasRole('super_admin'); ?>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <?php if($isSuperAdmin || Auth::user()->can('inventario de producto')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('productos.index')); ?>">Inventario de productos</a></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('registrar producto')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('productos.create')); ?>">Registrar producto</a></li>
                    <?php endif; ?>
                    <?php if($verFactCompra): ?>
                        <li><hr class="dropdown-divider"></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('listado de factura de compra')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('facturas_compras.index')); ?>">Listado de facturas de compra</a></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('registrar factura de compra')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('facturas_compras.create')); ?>">Registrar factura de compra</a></li>
                    <?php endif; ?>
                    <?php if($verFactVenta): ?>
                        <li><hr class="dropdown-divider"></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('listado de factura de venta')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('facturas_ventas.index')); ?>">Listado de facturas de venta</a></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('registrar factura de venta')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('facturas_ventas.create')); ?>">Registrar factura de venta</a></li>
                    <?php endif; ?>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <?php if($isSuperAdmin || Auth::user()->can('listado de instalación') || Auth::user()->can('registrar instalación')): ?>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                    <i class="bi bi-building me-2"></i>Instalaciones
                </a>
                <ul class="dropdown-menu">
                    <?php if($isSuperAdmin || Auth::user()->can('listado de instalación')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('instalaciones.index')); ?>">Listado de instalaciones</a></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('registrar instalación')): ?>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <?php if($isSuperAdmin || Auth::user()->can('listado de empleados')): ?>
            ...
            <?php if($isSuperAdmin || Auth::user()->can('listado de proveedores') || Auth::user()->can('registrar proveedor')): ?>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                    <i class="bi bi-truck me-2"></i>Proveedores
                </a>
                <ul class="dropdown-menu">
                    <?php if($isSuperAdmin || Auth::user()->can('listado de proveedores')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('Proveedores.indexProveedor')); ?>">Listado de proveedores</a></li>
                    <?php endif; ?>
                    <?php if($isSuperAdmin || Auth::user()->can('registrar proveedor')): ?>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo e(route('users.index')); ?>">Listado de usuarios</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('users.create')); ?>">Registrar usuario</a></li>
                </ul>
            </li>
            <?php endif; ?>
...
<?php /**PATH C:\Users\Admin\PhpstormProjects\Centinela\resources\views/plantilla.blade.php ENDPATH**/ ?>