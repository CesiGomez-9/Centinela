    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="user-info">
                ...
                <p><i class="bi bi-shield-fill-check"></i><strong>Rol asignado:</strong> <?php echo e($user->rol); ?></p>
            </div>
            ...
            <div class="permissions-grid">
                ...
                <?php $__currentLoopData = $permisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="permission-card"><?php echo e($permiso); ?></div>
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cesig\Herd\sistemadeseguridadcentinela\resources\views/users/verPermisos.blade.php ENDPATH**/ ?>