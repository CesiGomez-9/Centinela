    ...
    <div class="container my-3">
        <div class="form-contenedor position-relative">
            <h2 class="text-center mb-4 text-primary fs-8">
                <i class="bi bi-journal-plus me-2"></i> Editar servicio
            </h2>
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   oninput="limitarDigitos(this, 6)" required />
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            function updateProductVisibility(){
                ...
                if(selectCategoria.value === 'tecnico') tecnicoDiv.classList.remove('d-none');
            }
