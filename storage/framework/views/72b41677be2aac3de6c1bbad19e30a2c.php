            ...
            <form method="GET" action="<?php echo e(route('incidencias.index')); ?>">
                <div class="row mb-4 align-items-center">
                    ...
                    <div class="col-md-2 d-flex flex-column gap-2 align-items-start">
                        ...
                        <a href="<?php echo e(route('incidencias.index')); ?>" class="btn btn-sm btn-secondary px-2 py-1" style="font-size: 12px; width: 90px;">
                    ...
                    <div class="col-auto d-flex flex-column align-items-end">
                        ...
                        <a href="<?php echo e(route('incidencias.reporte', [
...
<?php echo $__env->make("plantilla", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cesig\Herd\sistemadeseguridadcentinela\resources\views/incidencias/index.blade.php ENDPATH**/ ?>