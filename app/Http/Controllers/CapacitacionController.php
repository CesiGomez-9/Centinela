...
// Actualizar los datos de la capacitación
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'nombre.required' => 'Debe ingresar el nombre la institución.',
            'nombre.regex' => 'El nombre de la institución solo debe contener letras, numeros, espacios y tildes.',
            ...
            'contacto.required' => 'Debe ingresar el nombre del contacto.',
            'contacto.regex' => 'El nombre del contacto solo debe contener letras y espacios y tildes.',
