        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{route('Clientes.indexCliente')}}">Lista de clientes</a></li>
                        <li><a class="dropdown-item" href="{{route('Clientes.formulariocliente')}}">Registrar un nuevo cliente</a></li>
                    </ul>
                </li>
