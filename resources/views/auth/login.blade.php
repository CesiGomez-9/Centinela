...
<div class="login-card">
    ...
    <form id="login-form" action="{{ route('login.process') }}" method="POST" novalidate autocomplete="off">
        @csrf
        ...
        @error('captcha_token')
        <div class="text-danger mb-2" style="font-size:0.9rem;">{{ $message }}</div>
        @enderror
