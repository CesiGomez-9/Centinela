    ...
    <div class="form-contenedor">
        ...
        <form id="servicioForm" action="{{ route('servicios.store') }}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <label for="tipo_personal" class="form-label fs-5">Tipo de personal</label>
                    <div class="input-group input-group-lg">
                        <span class="input-group-text"><i class="bi bi-people-fill"></i></span>
                        <select class="form-select form-select-lg" id="tipo_personal" name="tipo_personal" required>
