            ...
            <div class="col-xl-8 col-lg-9">
                <div class="card">
                    <div class="card-header position-relative">
                        ...
                        <small class="position-absolute top-50 end-0 translate-middle-y me-3">Creado {{ $producto->created_at->diffForHumans() }}</small>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><i class="bi bi-percent me-2"></i><strong>IVA:</strong> {{ $producto->material }}</p>
